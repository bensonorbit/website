...
export function Navbar() {
  return (
    <nav className="sticky top-0 z-50 border-b bg-background print:static print:bg-transparent print:pt-0">
      <div className="relative mx-auto grid h-(--navbar-height) max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-4 px-6 xl:border-x lg:grid-cols-[1fr_auto_1fr] lg:gap-8 print:px-0">
